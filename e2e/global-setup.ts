...
export default async function globalSetup() {
  ...
  try {
    await client.query(
      'TRUNCATE "User","Space","SpaceMember","Page","PageVersion","CollabDocument","SpaceInvitation","PasswordResetToken","PageLink","Comment","Notification","PageChunk","PageTemplate","Favorite","PageVisit" CASCADE',
    );
  } finally {
    await client.end();
  }
