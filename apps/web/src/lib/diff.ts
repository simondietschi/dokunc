 ...
 *
 * Daneben steht am Dateiende eine flache Wort-Sicht (DiffPart/diffWordParts),
 * die kein Zeilenraster kennt und für die kompakte Gegenüberstellung zweier
...
/* --------------------------------------------------------------------
 * Flache Wort-Sicht ohne Zeilenraster.
 *
 * Zweite Darstellung desselben Vergleichs: eine durchgehende Folge aus
 * gleichen, neuen und entfernten Wörtern samt Bilanz. Sie stützt sich
 * bewusst auf denselben Myers-Vergleich wie diffText — die frühere
 * Fassung baute eine LCS-Tabelle im Produkt beider Längen auf und musste
 * deshalb nach 2500 Wörtern abschneiden; das Budget in myers() löst das
 * ohne Textverlust.
 * ------------------------------------------------------------------ */
 ...
 * bleibt und nicht aus Hunderten Einzelwörtern besteht; innerhalb einer
 * Änderung steht erst das Entfernte, dann das Hinzugekommene.
 */
export function diffWordParts(before: string, after: string): DiffPart[] {
