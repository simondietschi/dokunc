...
export function EditorToolbar({ editor }: { editor: Editor | null }) {
  ...
  // Lazy: eine Chain führt ihre Befehle (auch focus) sofort beim Aufbau aus —
  // wäre sie im Render erzeugt, holte sich der Editor bei jedem Re-Render
  // den Fokus zurück (z. B. aus geöffneten Dialogen).
