 ...
 * Nur Seiten aus Spaces mit aktuellem Zugang — ein alter Besuch in
 * einem verlassenen Space darf dessen Titel nicht mehr verraten.
 *
 * Der Zugang kommt aus `accessibleSpaces`, nicht aus der eigenen
 * Mitgliedschaft: wer nur ueber eine Gruppe im Space ist, saehe sonst
 * seine eigenen Favoriten nicht mehr. `visiblePagesAcrossSpaces` nimmt
 * zusaetzlich geschuetzte Seiten heraus.
 */
