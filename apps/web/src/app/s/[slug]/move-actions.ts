...
import { refreshAccessRoots, visiblePageWhere } from "@/lib/page-access";
...
export async function movePageAction(form: FormData): Promise<MoveResult> {
  ...
  // Auch beim Verschieben gilt die Sichtbarkeit: eine geschuetzte Seite
  // darf nicht ueber eine untergeschobene ID bewegt werden.
  ...
  if (result.ok) {
    ...
    // ihr herausgeholt haben; ohne das Nachziehen bliebe der Unterbaum
    // mit der alten Zugriffswurzel stehen — sichtbar fuer die Falschen.
