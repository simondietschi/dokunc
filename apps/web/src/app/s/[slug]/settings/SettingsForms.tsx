  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          <option value="PRIVATE">Privat — nur mit Einladung sichtbar</option>
          <option value="OPEN">Offen — für alle Angemeldeten auffindbar</option>
        </select>
      </div>
      ...
      <div>
        ...
        <select
          id="joinRole"
          name="joinRole"
          defaultValue={joinRole === "VIEWER" ? "VIEWER" : "MEMBER"}
          className="h-10 w-full rounded-lg border border-line bg-surface px-3 text-sm text-ink focus-visible:border-accent focus-visible:outline-none"
        >
        ...
        <p className="mt-1.5 text-[12.5px] text-faint">
          Gilt nur für offene Spaces. Einladungen legen ihre Rolle selbst fest.
        </p>
      </div>
